...
const Testimonials = () => {
    const testimonialsStyles = `mx-auto relative max-w-[400px] h-[300px] flex flex-col justify-end p-16 mt-48 before:absolute before:top-[-120px] before:-ml-[110px] before:left-1/2`
